...
Write `docs/specflow/admin/config.json`:
...
Write `docs/specflow/admin/pages.json` with a placeholder structure — actual route inventory is generated by `specflow:test` or `specflow:pages` (a future skill):
...
### 8.4 decision-log.md and task-history.json
